...
export default (appEvents) => {
    ...
    const Authentication = {
        ...
        interceptTokens: function(details:any):void {
        ...
        interceptMsalToken: function(details:any, callback:any):void {
        ...
        requestMsalToken: function(body, headers){
            // Get MSAL Token
            ...
            this.request(options, data, reqHeaders).then((response) => {
        ...
        requestStreamingToken: function(streamingToken){
            ...
            this.request(options, data).then((response) => {
        ...
        requestxCloudToken: function(streamingToken){
        ...
        setAppTokens: function(level) {
            this._loggedIn = true
            this._appLevel = level

            this._appEvents.emit('start', this._tokens)
        }
    }
